  ...
  return (
    <li
      className={cx(
        ...
        "hover:bg-gray-100 sm:rounded-md p-2"
      )}
    >
      <Link href={href}>
        <a
      ...
      <nav className="container flex justify-between">
        ...
        <div className="flex flex-col justify-center md:flex-row">
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center justify-center p-2 text-gray-400 transition duration-150 ease-in-out rounded-md xl:hidden hover:text-primary-300 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-primary-300"
          >
            <svg
              className="w-6 h-6"
              stroke="currentColor"
